...
#### algorithms: 
Contains the implementation of the algorithm exercise.
Includes one class with the implementation of the solution.

#### design:
Contains the solutions to the design questions.
